...
function toast(title, subtitle) {
  document.getElementById('text').innerText = title + ' by '  || ' ';
...
function validateAuthentication() {
  ...
  if (accessToken) {
    connect();
    document.getElementById('loginshit').style.display = 'none'
    document.getElementById('spotifycontrols').style.display = ''
  } else {
    showLogin();
    document.getElementById('spotifycontrols').style.visibility = 'hidden'
    alert('no go');
  }
}
